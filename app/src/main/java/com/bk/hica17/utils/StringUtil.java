...
public class StringUtil {
    ...
    /**
     *
     * Convert char to English
     * @param ch: char want to convert
     * @return : char after convert
     */
    ...
    public static String standardString(String input) {

        // mac dinh la input da duoc trim(), tuc la da cat khoang trang dau va dit.
